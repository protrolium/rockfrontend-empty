...
final class ProductionStrategy
{
	...
	public function handleException(\Throwable $exception, bool $firstTime): void
	{
		...
		if (!$firstTime) {
			...
			(fn($logged) => require Debugger::$errorTemplate ?: \ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/assets/error.500.phtml')(empty($e));
