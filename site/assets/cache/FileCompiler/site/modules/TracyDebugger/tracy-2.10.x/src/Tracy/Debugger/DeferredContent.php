...
final class DeferredContent
{
	...
	private function buildJsCss(): string
	{
		$css = array_map('file_get_contents', array_merge([
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/reset.css',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../Bar/assets/bar.css',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/toggle.css',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/table-sort.css',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/tabs.css',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../Dumper/assets/dumper-light.css',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../Dumper/assets/dumper-dark.css',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../BlueScreen/assets/bluescreen.css',
		], Debugger::$customCssFiles));

		$js1 = array_map(fn($file) => '(function() {' . file_get_contents($file) . '})();', [
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../Bar/assets/bar.js',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/toggle.js',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/table-sort.js',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/tabs.js',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../Dumper/assets/dumper.js',
			'/Applications/MAMP/htdocs/rockfrontend-empty/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../BlueScreen/assets/bluescreen.js',
		]);
